...
function getEnemyAnimations(){
  return {
    ...
    attack_right_first: {name: 'attack_right_first', firstSprite: 1, lastSprite: 26, fps:10, loop : false},
    attack_left_first: {name: 'attack_left_first', firstSprite: 1, lastSprite: 26, fps:10, loop : false},
    attack_right_second: {name: 'attack_right_second', firstSprite: 1, lastSprite: 22, fps:10, loop : false},
    attack_left_second: {name: 'attack_left_second', firstSprite: 1, lastSprite: 22, fps:10, loop : false},
